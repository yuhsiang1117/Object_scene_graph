...
# (no success_distance constant here: this script classifies by distance to the
# goal OBJECT / view-point sets, not by the success threshold. The threshold now
# varies per run -- see scripts/analyze_stages.py::success_dist.)
